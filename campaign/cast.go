...
var TheSet = []Member{
	{
		...
		Capability: Capability{
			...
			Unread:     "You haven't been round him enough to tell the difference between him committing and him going further than you'd have chosen",
			Unprompted: "He says what he's going to do before he does it, so you're never guessing which it is",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unread:     "It's all noise to you, and you can't yet tell which of it you're meant to act on",
			Unprompted: "You know by now which of it is nerves and which of it is him telling you something",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unread:     "You don't know what makes him say it, so when he does you've only got his word for it",
			Unprompted: "When he says no he tells you what he saw, and you can decide with him instead of after him",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unread:     "You can't tell how long he means to stay, so you can't plan around him",
			Unprompted: "He tells you what he's waiting on, so it isn't a surprise when he won't move",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unread:     "He's gone before you've registered why, and you spend the whole thing behind him",
			Unprompted: "You've been out with him enough to move when he moves, which is most of it",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unread:     "Where he's taking you is his business, because you've never once asked",
			Unprompted: "He talks the route through before you go, and by now you know it as well as he does",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unread:     "You can't tell what he's registered and what he hasn't, and it matters which",
			Unprompted: "You can tell when the calm is real and when he's holding it together, which nobody else can",
		},
	...
	},
	{
		...
		Capability: Capability{
			...
			Unprompted: "He says what he's thinking without being asked, because he always has",
		},
